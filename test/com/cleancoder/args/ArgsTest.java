...
public class ArgsTest {
  ...
  public void testSpacesInFormat() throws Exception {
    try{
    	new ArgumentParser("x,y", new String[]{"-xy"});
    }catch(ArgsException e){
    	assertEquals(INVALID_ARGUMENT_FORMAT,e.getErrorCode());
    }
  }
  ...
  public void malFormedMapArgument() throws Exception {
    new ArgumentParser("f&", new String[] {"-f", "key1:val1,key2"});
  }
  ...
  public void testExtraArguments() throws Exception {
    try{
    	new ArgumentParser("x,y*", new String[]{"-x", "-y", "alpha", "beta","gamma"});
    }catch(ArgsException e){
    	assertEquals(INVALID_ARGUMENT_FORMAT,e.getErrorCode());
    }
  }
  ...
  public void testExtraArgumentsThatLookLikeFlags() throws Exception {
    ...
    try{
    	new ArgumentParser("x,y", new String[]{"-x", "alpha", "-y", "beta"});
    }catch(ArgsException e){
    	assertEquals(INVALID_ARGUMENT_FORMAT,e.getErrorCode());
    }
  }
